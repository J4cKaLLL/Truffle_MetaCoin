...
// 12-word mnemonic
var mnemonic = "tank father siren saddle appear gallery host mountain nuclear marine off churn";
...
module.exports = {
  ...
  rinkeby: {
    provider: () =>  new HDWalletProvider(mnemonic, "https://rinkeby.infura.io/v3/10a04692be4f474f92dde86bd7c11d11"),
    network_id: 4 // official id of the ropsten network
  },
  live: {
